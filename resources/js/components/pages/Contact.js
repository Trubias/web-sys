...
export default function Contact() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const msg = (err.response?.data?.error || err.response?.data?.message || 'Something went wrong. Please try again.') + status;
            setError(msg);
        } finally {
            setLoading(false);
        }
                        ...
                        <div className="contact-info">
                            ...
                            <div className="contact-info__item">
                                ...
                                <div>
                                    ...
                                    <p>Phone: +63 2 1234 5678<br />Email: krickjay2000@gmail.com</p>
                                </div>
                            </div>
